    ...
    return (
        <section className="py-20 bg-black overflow-hidden border-y border-white/5">
            <div className="max-w-6xl mx-auto px-6">
                <p className="text-center text-[10px] font-cormorant text-gray-500 uppercase tracking-[0.3em] mb-12">Tecnologías de Vanguardia</p>
                <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-50 hover:opacity-100 transition-opacity duration-700">
                    {techs.map((t, i) => (
                        <motion.span
                            ...
                            className={`text-xl md:text-3xl font-cinzel font-bold cursor-default ${t.color} filter grayscale hover:grayscale-0 transition-all`}
                        >
                            {t.name}
                        </motion.span>
                    ))}
