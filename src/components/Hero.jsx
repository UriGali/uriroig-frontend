...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center items-center bg-black text-white px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-gold-600/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        <h2 className="text-gold-500 font-cormorant tracking-widest uppercase text-[10px] mb-4 italic">
          Agencia de Desarrollo Web & Automatización n8n
        </h2>
        <h1 className="text-6xl font-cinzel md:text-8xl font-cinzel font-bold mb-6 tracking-tighter">
          Aurum <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-gold-600 font-light italic">& Heritage</span>
        </h1>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          <Link
            to="/contacto"
            className="bg-white text-black px-10 py-4 rounded-full font-bold hover:bg-gold-400 transition-all hover:scale-105 shadow-xl shadow-white/5"
          >
            Pedir Presupuesto
          </Link>
          <a
