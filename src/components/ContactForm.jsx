  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Alerta con icono Pro de Lucide y estilo minimalista
        toast.success(`¡Recibido, ${formData.name}! Hablamos pronto.`, {
      ...
      setStatus('error');
      toast.error("Sin conexión. ¿Has iniciado el backend?");
    }
  };
    ...
    <section id="contact" className="py-10 bg-black px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 italic max-w-lg mx-auto">Cuéntame tu visión y la haré realidad con tecnología de vanguardia.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1 space-y-4">
            <div className="bg-white/[0.02] border border-white/5 p-8 rounded-[2rem] backdrop-blur-3xl">
              <h3 className="text-blue-500 font-mono text-[9px] uppercase tracking-[0.4em] mb-10 font-bold font-bold font-bold">Vías Directas</h3>

              <div className="space-y-8">
                <a href="mailto:hola@uriroig.dev" className="flex items-center gap-5 group">
                  <div className="p-3 bg-blue-500/5 rounded-2xl group-hover:bg-blue-500/20 transition-all border border-white/5">
                    <Mail className="w-5 h-5 text-blue-500" />
                  </div>
                  <div className="text-left">
                    <p className="text-[9px] text-gray-600 uppercase font-mono tracking-widest">Email</p>
                ...
                <a href="https://wa.me/34600000000" target="_blank" rel="noreferrer" className="flex items-center gap-5 group">
                  ...
                  <div className="text-left">
                    <p className="text-[9px] text-gray-600 uppercase font-mono tracking-widest">WhatsApp</p>
                    <p className="text-sm text-gray-300 font-medium italic">Chat de Matadepera</p>
                  </div>
                </a>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white/[0.01] border border-white/5 p-8 md:p-12 rounded-[3rem] shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-gray-600 uppercase tracking-widest ml-1 font-bold">Nombre</label>
                  <input
                    type="text"
                    value={formData.name}
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-mono text-gray-600 uppercase tracking-widest ml-1 font-bold">Email Profesional</label>
                  <input
                    type="email"
              ...
              <div className="mb-8 space-y-2">
                ...
                >
                  <option className="bg-neutral-900" value="Desarrollo Web">Creación de Web de Élite</option>
                  <option className="bg-neutral-900" value="Automatización">Automatización con n8n</option>
                  <option className="bg-neutral-900" value="Growth">Estrategia de Ads & Growth</option>
                </select>
              </div>
              ...
              >
                {status === 'enviando' ? 'Procesando...' : 'Enviar Propuesta'}
